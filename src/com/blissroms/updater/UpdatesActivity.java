    ...
    private void downloadUpdatesList(final boolean manualRefresh) {
        ...
        DownloadClient.DownloadCallback callback = new DownloadClient.DownloadCallback() {
            ...
            public void onFailure(final boolean cancelled) {
                ...
                runOnUiThread(() -> {
                    if (!cancelled) {
                        ((TextView) findViewById(R.id.header_update_status)).setText(R.string.snack_updates_server_failed);
                    }
                });
            }
        ...
        try {
            ...
            ((TextView) findViewById(R.id.header_update_status)).setText(R.string.snack_download_client_failed);
            return;
        }
