...
public class UpdatesDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + UpdateEntry.TABLE_NAME + " (" +
                    ...
                    UpdateEntry.COLUMN_NAME_VARIANT + " TEXT," +
    ...
    public long addUpdate(Update update) {
        ...
        values.put(UpdateEntry.COLUMN_NAME_VARIANT, update.getVariant());
    ...
    public List<Update> getUpdates(String selection, String[] selectionArgs) {
        ...
        String[] projection = {
                ...
                UpdateEntry.COLUMN_NAME_VARIANT,
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                index = cursor.getColumnIndex(UpdateEntry.COLUMN_NAME_VARIANT);
                update.setVariant(cursor.getString(index));
