...
updates_dir=/data/bliss_updaters
...
adb shell "killall com.blissroms.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.blissroms.updater/databases/updates.db" \
